...
<head>
  ...
  <link rel="stylesheet" href="{{ secure_asset('assets/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css')}}">
  <!-- iCheck -->
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="{{ secure_asset('assets/css/alt/adminlte.min.css')}}">
  ...
  <!-- summernote -->
  <link rel="stylesheet" href="{{ secure_asset('assets/plugins/summernote/summernote-bs4.min.css')}}">
  <!-- datatable -->
